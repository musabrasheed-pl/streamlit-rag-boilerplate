...
class RAGApp:
    ...
    def answer_query(self, vectorstore, query):
        ...
        # result = qa_chain({"question": query, "chat_history": st.session_state.conversation_history})
        ...
        result = qa_chain({
            "question": query,
            "history": history_text,  # Include history in the prompt
...
def main():
    ...
    # Query Input and Answer Retrieval
